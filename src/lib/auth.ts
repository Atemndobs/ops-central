...
const ROUTE_ACCESS: Record<UserRole, string[]> = {
  admin: ["/"],
  property_ops: ["/", "/schedule", "/jobs", "/messages", "/review", "/properties", "/companies", "/team", "/incidents", "/maintenance", "/reports"],
  manager: ["/", "/schedule", "/jobs", "/messages", "/review", "/properties", "/companies", "/team", "/incidents", "/maintenance", "/reports"],
  cleaner: ["/cleaner"],
};
